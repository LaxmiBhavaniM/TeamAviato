...
public class DataIngestorInit implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent event) 
    {
    	...
    	String serviceURI = "http://localhost:8080/dataingestor/webapi/service/url";
        ...
        {            
			...
			ServiceInstance serviceInstance = ServiceInstance.builder().uriSpec(new UriSpec(serviceURI)).address("localhost").port(port)
