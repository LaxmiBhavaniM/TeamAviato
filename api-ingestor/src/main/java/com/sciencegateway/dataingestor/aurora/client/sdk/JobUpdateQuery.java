                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                            {
                                ...
                                for (int _i256 = 0; _i256 < _set254.size; ++_i256) {
                                    _elem255 = com.sciencegateway.dataingestor.aurora.client.sdk.JobUpdateStatus.findByValue(iprot.readI32());
            ...
            if (incoming.get(4)) {
                {
                    ...
                    for (int _i261 = 0; _i261 < _set259.size; ++_i261) {
                        _elem260 = com.sciencegateway.dataingestor.aurora.client.sdk.JobUpdateStatus.findByValue(iprot.readI32());
