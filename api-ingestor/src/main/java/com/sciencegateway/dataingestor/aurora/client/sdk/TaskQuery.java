                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                            {
                                ...
                                for (int _i155 = 0; _i155 < _set153.size; ++_i155) {
                                    _elem154 = com.sciencegateway.dataingestor.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
            ...
            if (incoming.get(4)) {
                {
                    ...
                    for (int _i180 = 0; _i180 < _set178.size; ++_i180) {
                        _elem179 = com.sciencegateway.dataingestor.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
